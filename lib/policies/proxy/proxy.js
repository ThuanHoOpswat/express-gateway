...
const httpAgent = new http.Agent({ keepAlive: true, timeout: 1200 * 1000 });
const httpsAgent = new https.Agent({ keepAlive: true, timeout: 1200 * 1000 });

httpAgent.keepAliveTimeout = 1200 * 1000;
httpsAgent.keepAliveTimeout = 1200 * 1000;
