...
const time = 2400 * 1000;
const httpAgent = new http.Agent({ keepAlive: true, timeout: time });
const httpsAgent = new https.Agent({ keepAlive: true, timeout: time });

httpAgent.keepAliveTimeout = time;
httpsAgent.keepAliveTimeout = time;
...
module.exports = function (params, config) {
  ...
  proxyOptions.proxyTimeout = time;
  proxyOptions.timeout = time;
